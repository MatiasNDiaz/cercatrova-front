        ...
        <ul className="hidden md:flex flex-row gap-4 items-center ml-auto mr-8">
          ...
          <li>
            <button onClick={() => scrollTo("inicio")}
              ...
              <span className="relative group-hover:text-[#0f8b57] transition-colors duration-300">
                <Home size={18} className="inline mr-2 mb-0.5" />inicio
              </span>
          ...
          <li className="relative group">
            <span className="flex items-center text-lg font-semibold text-[#0b7a4b] p-2 cursor-pointer">
              <Building2 size={18} className="inline mr-2 mt-1" />propiedades
          ...
          {!isAdmin && (
            <li>
              <Link href="/publicar"
                ...
                <span className="relative group-hover:text-[#0f8b57] transition-colors duration-300">
                  <PlusSquare size={18} className="inline mr-2 mb-0.5" />publicar propiedad
                </span>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <ul className="space-y-3">
                <li>
                  <button onClick={() => scrollTo("inicio", closeMenu)}
                ...
                <li>
                  <button onClick={() => setActiveSubmenu("propiedades")}
