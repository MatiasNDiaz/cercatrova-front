...
export interface Property {
  ...
  localidad: string;
  barrio: string;
  /** Calle y número — fuente del mapa en el detalle. Null en las propiedades cargadas antes de este campo. */
  direccion: string | null;
  zone: string;
  rooms: number;
  bathrooms: number;
  /** Documentación legal: los tres son independientes, pueden convivir */
